[![Build Status](https://travis-ci.org/tollmanz/wordpress-pecl-memcached-object-cache.png?branch=master)](https://travis-ci.org/tollmanz/wordpress-memcached-backend)
